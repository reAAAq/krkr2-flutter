    ...
    try {
        ...
        while (true) {
            ...
            for (;;) {
                ...
                // find 'segm' sub-chunk
                // Each of in-archive storages can be splitted into some
                // segments. Each segment can be compressed or uncompressed
                // independently. segments can share partial area of archive
