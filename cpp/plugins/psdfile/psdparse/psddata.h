...
namespace psd {
    ...
    struct ImageResourceInfo {
        ImageResourceInfo(uint16_t id, std::string &name, int size, IteratorBase *data) : id(id),
                                                                                          name(name),
                                                                                          size(size),
                                                                                          data(data) {};
    ...
    struct AdditionalLayerInfo {
        AdditionalLayerInfo(int sigType, int key, int size, IteratorBase *data) : sigType(sigType),
                                                                                  key(key),
                                                                                  size(size),
                                                                                  data(data) {
        }
