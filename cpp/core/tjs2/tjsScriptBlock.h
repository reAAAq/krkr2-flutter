...
public:
    ...
    tjs_uint
    GetTotalVMCodeSize() const; // returns in VM word size ( 1 word = 32bit )
...
public:
    ...
    void Compile(const tjs_char *text, bool isexpression, bool isresultneeded,
                 bool outputdebug, tTJSBinaryStream *output);
