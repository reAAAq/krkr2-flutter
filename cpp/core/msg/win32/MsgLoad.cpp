...
void TVPLoadMessage() {
    ...
    for (int i = 0; i < NUM_MESSAGE_MAX; i++) {
        int len = ::LoadString(hInstance, RESOURCE_IDS[i], buffer,
                               MAX_MESSAGE_LENGTH);
        if (len <= 0) {
    ...
    TJSWarnEvalOperator.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_WARN_EVAL_OPERATOR]);
    TJSNarrowToWideConversionError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_NARROW_TO_WIDE_CONVERSION_ERROR]);
    TJSVariantConvertError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_VARIANT_CONVERT_ERROR]);
    TJSVariantConvertErrorToObject.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_VARIANT_CONVERT_ERROR_TO_OBJECT]);
    TJSIDExpected.AssignMessage(RESOURCE_MESSAGE[NUM_TJS_IDEXPECTED]);
    TJSSubstitutionInBooleanContext.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_SUBSTITUTION_IN_BOOLEAN_CONTEXT]);
    TJSCannotModifyLHS.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_CANNOT_MODIFY_LHS]);
    TJSInsufficientMem.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_INSUFFICIENT_MEM]);
    TJSCannotGetResult.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_CANNOT_GET_RESULT]);
    ...
    TJSMemberNotFoundNoNameGiven.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_MEMBER_NOT_FOUND_NO_NAME_GIVEN]);
    ...
    TJSSpecifyDicOrArray.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_SPECIFY_DIC_OR_ARRAY]);
    TJSSpecifyArray.AssignMessage(RESOURCE_MESSAGE[NUM_TJS_SPECIFY_ARRAY]);
    TJSStringDeallocError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_STRING_DEALLOC_ERROR]);
    TJSStringAllocError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_STRING_ALLOC_ERROR]);
    TJSMisplacedBreakContinue.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_MISPLACED_BREAK_CONTINUE]);
    TJSMisplacedCase.AssignMessage(RESOURCE_MESSAGE[NUM_TJS_MISPLACED_CASE]);
    TJSMisplacedReturn.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_MISPLACED_RETURN]);
    TJSStringParseError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_STRING_PARSE_ERROR]);
    TJSNumberError.AssignMessage(RESOURCE_MESSAGE[NUM_TJS_NUMBER_ERROR]);
    TJSUnclosedComment.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_UNCLOSED_COMMENT]);
    ...
    TJSNativeClassCrash.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_NATIVE_CLASS_CRASH]);
    ...
    TJSCannotParseDate.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_CANNOT_PARSE_DATE]);
    TJSInvalidValueForTimestamp.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_INVALID_VALUE_FOR_TIMESTAMP]);
    TJSExceptionNotFound.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_EXCEPTION_NOT_FOUND]);
    TJSInvalidFormatString.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_INVALID_FORMAT_STRING]);
    TJSDivideByZero.AssignMessage(RESOURCE_MESSAGE[NUM_TJS_DIVIDE_BY_ZERO]);
    TJSNotReconstructiveRandomizeData.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_NOT_RECONSTRUCTIVE_RANDOMIZE_DATA]);
    TJSSymbol.AssignMessage(RESOURCE_MESSAGE[NUM_TJS_SYMBOL]);
    TJSCallHistoryIsFromOutOfTJS2Script.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_CALL_HISTORY_IS_FROM_OUT_OF_TJS2SCRIPT]);
    TJSNObjectsWasNotFreed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_NOBJECTS_WAS_NOT_FREED]);
#ifdef TJS_TEXT_OUT_CRLF
    TJSObjectCreationHistoryDelimiter.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_OBJECT_CREATION_HISTORY_DELIMITER_CRLF]);
#else
    TJSObjectCreationHistoryDelimiter.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_OBJECT_CREATION_HISTORY_DELIMITER]);
#endif
#ifdef TJS_TEXT_OUT_CRLF
    TJSObjectWasNotFreed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_OBJECT_WAS_NOT_FREED_CRLF]);
#else
    TJSObjectWasNotFreed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_OBJECT_WAS_NOT_FREED]);
#endif
    TJSGroupByObjectTypeAndHistory.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_GROUP_BY_OBJECT_TYPE_AND_HISTORY]);
    TJSGroupByObjectType.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_GROUP_BY_OBJECT_TYPE]);
#ifdef TJS_TEXT_OUT_CRLF
    TJSObjectCountingMessageGroupByObjectTypeAndHistory.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TJS_OBJECT_COUNTING_MESSAGE_GROUP_BY_OBJECT_TYPE_AND_HISTORY_CRLF]);
#else
    TJSObjectCountingMessageGroupByObjectTypeAndHistory.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TJS_OBJECT_COUNTING_MESSAGE_GROUP_BY_OBJECT_TYPE_AND_HISTORY]);
#endif
    TJSObjectCountingMessageTJSGroupByObjectType.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TJS_OBJECT_COUNTING_MESSAGE_TJSGROUP_BY_OBJECT_TYPE]);
#ifdef TJS_TEXT_OUT_CRLF
    TJSWarnRunningCodeOnDeletingObject.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_WARN_RUNNING_CODE_ON_DELETING_OBJECT_CRLF]);
#else
    TJSWarnRunningCodeOnDeletingObject.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_WARN_RUNNING_CODE_ON_DELETING_OBJECT]);
#endif
    ...
    TJSObjectHashMapLogVersionMismatch.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_OBJECT_HASH_MAP_LOG_VERSION_MISMATCH]);
    TJSCurruptedObjectHashMapLog.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_CURRUPTED_OBJECT_HASH_MAP_LOG]);
    TJSUnknownFailure.AssignMessage(RESOURCE_MESSAGE[NUM_TJS_UNKNOWN_FAILURE]);
    TJSUnknownPackUnpackTemplateCharcter.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_UNKNOWN_PACK_UNPACK_TEMPLATE_CHARCTER]);
    TJSUnknownBitStringCharacter.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_UNKNOWN_BIT_STRING_CHARACTER]);
    TJSUnknownHexStringCharacter.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_UNKNOWN_HEX_STRING_CHARACTER]);
    TJSNotSupportedUuencode.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_NOT_SUPPORTED_UUENCODE]);
    TJSNotSupportedBER.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_NOT_SUPPORTED_BER]);
    TJSNotSupportedUnpackLP.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_NOT_SUPPORTED_UNPACK_LP]);
    TJSNotSupportedUnpackP.AssignMessage(
        RESOURCE_MESSAGE[NUM_TJS_NOT_SUPPORTED_UNPACK_P]);
    TVPVersionInformation.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_VERSION_INFORMATION]);
    TVPVersionInformation2.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_VERSION_INFORMATION2]);
    TVPDownloadPageURL.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_DOWNLOAD_PAGE_URL]);
    ...
    TVPWarnDebugOptionEnabled.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_WARN_DEBUG_OPTION_ENABLED]);
    TVPCommandLineParamIgnoredAndDefaultUsed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_COMMAND_LINE_PARAM_IGNORED_AND_DEFAULT_USED]);
    TVPInvalidCommandLineParam.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_COMMAND_LINE_PARAM]);
    TVPNotImplemented.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_NOT_IMPLEMENTED]);
    TVPCannotOpenStorage.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_OPEN_STORAGE]);
    TVPCannotFindStorage.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_FIND_STORAGE]);
    TVPCannotOpenStorageForWrite.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_OPEN_STORAGE_FOR_WRITE]);
    TVPStorageInArchiveNotFound.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_STORAGE_IN_ARCHIVE_NOT_FOUND]);
    TVPInvalidPathName.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_PATH_NAME]);
    TVPUnsupportedMediaName.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_MEDIA_NAME]);
    TVPCannotUnbindXP3EXE.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_UNBIND_XP3EXE]);
    TVPCannotFindXP3Mark.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_FIND_XP3MARK]);
    TVPMissingPathDelimiterAtLast.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_MISSING_PATH_DELIMITER_AT_LAST]);
    TVPFilenameContainsSharpWarn.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FILENAME_CONTAINS_SHARP_WARN]);
    TVPCannotGetLocalName.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_GET_LOCAL_NAME]);
    ...
    TVPInsufficientMemory.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INSUFFICIENT_MEMORY]);
    TVPUncompressionFailed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNCOMPRESSION_FAILED]);
    TVPCompressionFailed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_COMPRESSION_FAILED]);
    TVPCannotWriteToArchive.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_WRITE_TO_ARCHIVE]);
    TVPUnsupportedCipherMode.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_CIPHER_MODE]);
    TVPUnsupportedEncoding.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_ENCODING]);
    TVPUnsupportedModeString.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_MODE_STRING]);
    TVPUnknownGraphicFormat.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNKNOWN_GRAPHIC_FORMAT]);
    TVPCannotSuggestGraphicExtension.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_SUGGEST_GRAPHIC_EXTENSION]);
    TVPMaskSizeMismatch.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_MASK_SIZE_MISMATCH]);
    TVPProvinceSizeMismatch.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_PROVINCE_SIZE_MISMATCH]);
    ...
    TVPInvalidImageSaveType.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_IMAGE_SAVE_TYPE]);
    TVPInvalidOperationFor8BPP.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_OPERATION_FOR8BPP]);
    TVPInvalidOperationFor32BPP.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_OPERATION_FOR32BPP]);
    ...
    TVPSpecifyLayerOrBitmap.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_SPECIFY_LAYER_OR_BITMAP]);
    TVPCannotAcceptModeAuto.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_ACCEPT_MODE_AUTO]);
    TVPCannotCreateEmptyLayerImage.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_CREATE_EMPTY_LAYER_IMAGE]);
    TVPCannotSetPrimaryInvisible.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_SET_PRIMARY_INVISIBLE]);
    TVPCannotMovePrimary.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_MOVE_PRIMARY]);
    TVPCannotSetParentSelf.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_SET_PARENT_SELF]);
    TVPCannotMoveNextToSelfOrNotSiblings.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_MOVE_NEXT_TO_SELF_OR_NOT_SIBLINGS]);
    TVPCannotMovePrimaryOrSiblingless.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_MOVE_PRIMARY_OR_SIBLINGLESS]);
    TVPCannotMoveToUnderOtherPrimaryLayer.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_MOVE_TO_UNDER_OTHER_PRIMARY_LAYER]);
    TVPInvalidImagePosition.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_IMAGE_POSITION]);
    TVPCannotSetModeToDisabledOrModal.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_SET_MODE_TO_DISABLED_OR_MODAL]);
    TVPNotDrawableLayerType.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_NOT_DRAWABLE_LAYER_TYPE]);
    TVPSourceLayerHasNoImage.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_SOURCE_LAYER_HAS_NO_IMAGE]);
    TVPUnsupportedLayerType.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_LAYER_TYPE]);
    TVPNotDrawableFaceType.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_NOT_DRAWABLE_FACE_TYPE]);
    TVPCannotConvertLayerTypeUsingGivenDirection.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_CANNOT_CONVERT_LAYER_TYPE_USING_GIVEN_DIRECTION]);
    TVPNegativeOpacityNotSupportedOnThisFace.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_NEGATIVE_OPACITY_NOT_SUPPORTED_ON_THIS_FACE]);
    TVPSrcRectOutOfBitmap.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_SRC_RECT_OUT_OF_BITMAP]);
    TVPBoxBlurAreaMustContainCenterPixel.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_BOX_BLUR_AREA_MUST_CONTAIN_CENTER_PIXEL]);
    TVPBoxBlurAreaMustBeSmallerThan16Million.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_BOX_BLUR_AREA_MUST_BE_SMALLER_THAN16MILLION]);
    TVPCannotChangeFocusInProcessingFocus.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_CHANGE_FOCUS_IN_PROCESSING_FOCUS]);
    TVPWindowHasNoLayer.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_WINDOW_HAS_NO_LAYER]);
    TVPWindowHasAlreadyPrimaryLayer.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_WINDOW_HAS_ALREADY_PRIMARY_LAYER]);
    TVPSpecifiedEventNeedsParameter.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_SPECIFIED_EVENT_NEEDS_PARAMETER]);
    TVPSpecifiedEventNeedsParameter2.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_SPECIFIED_EVENT_NEEDS_PARAMETER2]);
    TVPSpecifiedEventNameIsUnknown.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_SPECIFIED_EVENT_NAME_IS_UNKNOWN]);
    TVPOutOfRectangle.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_OUT_OF_RECTANGLE]);
    TVPInvalidMethodInUpdating.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_METHOD_IN_UPDATING]);
    TVPCannotCreateInstance.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_CREATE_INSTANCE]);
    TVPUnknownWaveFormat.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNKNOWN_WAVE_FORMAT]);
    TVPCurrentTransitionMustBeStopping.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CURRENT_TRANSITION_MUST_BE_STOPPING]);
    TVPTransHandlerError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TRANS_HANDLER_ERROR]);
    TVPTransAlreadyRegistered.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TRANS_ALREADY_REGISTERED]);
    TVPCannotFindTransHander.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_FIND_TRANS_HANDER]);
    TVPSpecifyTransitionSource.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_SPECIFY_TRANSITION_SOURCE]);
    TVPLayerCannotHaveImage.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_LAYER_CANNOT_HAVE_IMAGE]);
    TVPTransitionSourceAndDestinationMustHaveImage.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_TRANSITION_SOURCE_AND_DESTINATION_MUST_HAVE_IMAGE]);
    TVPCannotLoadRuleGraphic.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_LOAD_RULE_GRAPHIC]);
    TVPSpecifyOption.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_SPECIFY_OPTION]);
    TVPTransitionLayerSizeMismatch.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TRANSITION_LAYER_SIZE_MISMATCH]);
    TVPTransitionMutualSource.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TRANSITION_MUTUAL_SOURCE]);
    TVPHoldDestinationAlphaParameterIsNowDeprecated.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_HOLD_DESTINATION_ALPHA_PARAMETER_IS_NOW_DEPRECATED]);
    TVPCannotConnectMultipleWaveSoundBufferAtOnce.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_CANNOT_CONNECT_MULTIPLE_WAVE_SOUND_BUFFER_AT_ONCE]);
    TVPInvalidWindowSizeMustBeIn64to32768.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_WINDOW_SIZE_MUST_BE_IN64TO32768]);
    TVPInvalidOverlapCountMustBeIn2to32.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_OVERLAP_COUNT_MUST_BE_IN2TO32]);
    TVPCurrentlyAsyncLoadBitmap.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CURRENTLY_ASYNC_LOAD_BITMAP]);
    TVPFaildClipboardCopy.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FAILD_CLIPBOARD_COPY]);
    TVPInvalidUTF16ToUTF8.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_UTF16TO_UTF8]);
    TVPInfoLoadingStartupScript.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_LOADING_STARTUP_SCRIPT]);
    TVPInfoStartupScriptEnded.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_STARTUP_SCRIPT_ENDED]);
    TVPTjsCharMustBeTwoOrFour.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TJS_CHAR_MUST_BE_TWO_OR_FOUR]);
    TVPMediaNameHadAlreadyBeenRegistered.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_MEDIA_NAME_HAD_ALREADY_BEEN_REGISTERED]);
    TVPMediaNameIsNotRegistered.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_MEDIA_NAME_IS_NOT_REGISTERED]);
    TVPInfoRebuildingAutoPath.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_REBUILDING_AUTO_PATH]);
    TVPInfoTotalFileFoundAndActivated.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_TOTAL_FILE_FOUND_AND_ACTIVATED]);
    TVPErrorInRetrievingSystemOnActivateOnDeactivate.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_ERROR_IN_RETRIEVING_SYSTEM_ON_ACTIVATE_ON_DEACTIVATE]);
    TVPTheHostIsNotA16BitUnicodeSystem.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_THE_HOST_IS_NOT_A16BIT_UNICODE_SYSTEM]);
    TVPInfoTryingToReadXp3VirtualFileSystemInformationFrom.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_INFO_TRYING_TO_READ_XP3VIRTUAL_FILE_SYSTEM_INFORMATION_FROM]);
    TVPSpecifiedStorageHadBeenProtected.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_SPECIFIED_STORAGE_HAD_BEEN_PROTECTED]);
    TVPInfoFailed.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_INFO_FAILED]);
    TVPInfoDoneWithContains.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_DONE_WITH_CONTAINS]);
    ...
    TVPDefaultFontName.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_DEFAULT_FONT_NAME]);
    TVPCannotOpenFontFile.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_OPEN_FONT_FILE]);
    TVPFontCannotBeUsed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FONT_CANNOT_BE_USED]);
    TVPFontRasterizeError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FONT_RASTERIZE_ERROR]);
    TVPBitFieldsNotSupported.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_BIT_FIELDS_NOT_SUPPORTED]);
    TVPCompressedBmpNotSupported.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_COMPRESSED_BMP_NOT_SUPPORTED]);
    TVPUnsupportedColorModeForPalettImage.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_COLOR_MODE_FOR_PALETT_IMAGE]);
    TVPNotWindowsBmp.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_NOT_WINDOWS_BMP]);
    TVPUnsupportedHeaderVersion.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_HEADER_VERSION]);
    ...
    TVPAbortedLimitByte.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_ABORTED_LIMIT_BYTE]);
    TVPFaildGlyphForDrawGlyph.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FAILD_GLYPH_FOR_DRAW_GLYPH]);
    TVPLayerObjectIsNotProperlyConstructed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_LAYER_OBJECT_IS_NOT_PROPERLY_CONSTRUCTED]);
    TVPUnknownUpdateType.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNKNOWN_UPDATE_TYPE]);
    TVPUnknownTransitionType.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNKNOWN_TRANSITION_TYPE]);
    TVPUnsupportedUpdateTypeTutGiveUpdate.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_UPDATE_TYPE_TUT_GIVE_UPDATE]);
    TVPErrorCode.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_ERROR_CODE]);
    TVPUnsupportedJpegPalette.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_JPEG_PALETTE]);
    TVPLibpngError.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_LIBPNG_ERROR]);
    TVPUnsupportedColorTypePalette.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_COLOR_TYPE_PALETTE]);
    TVPUnsupportedColorType.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_COLOR_TYPE]);
    ...
    TVPTlgUnsupportedUniversalTransitionRule.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TLG_UNSUPPORTED_UNIVERSAL_TRANSITION_RULE]);
    TVPUnsupportedColorCount.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_COLOR_COUNT]);
    TVPDataFlagMustBeZero.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_DATA_FLAG_MUST_BE_ZERO]);
    TVPUnsupportedColorTypeColon.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_COLOR_TYPE_COLON]);
    TVPUnsupportedExternalGolombBitLengthTable.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_EXTERNAL_GOLOMB_BIT_LENGTH_TABLE]);
    TVPUnsupportedEntropyCodingMethod.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_UNSUPPORTED_ENTROPY_CODING_METHOD]);
    TVPInvalidTlgHeaderOrVersion.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_TLG_HEADER_OR_VERSION]);
    TVPTlgMalformedTagMissionColonAfterNameLength.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_TLG_MALFORMED_TAG_MISSION_COLON_AFTER_NAME_LENGTH]);
    TVPTlgMalformedTagMissionEqualsAfterName.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TLG_MALFORMED_TAG_MISSION_EQUALS_AFTER_NAME]);
    TVPTlgMalformedTagMissionColonAfterVaueLength.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_TLG_MALFORMED_TAG_MISSION_COLON_AFTER_VAUE_LENGTH]);
    TVPTlgMalformedTagMissionCommaAfterTag.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TLG_MALFORMED_TAG_MISSION_COMMA_AFTER_TAG]);
    TVPFileSizeIsZero.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FILE_SIZE_IS_ZERO]);
    TVPMemoryAllocationError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_MEMORY_ALLOCATION_ERROR]);
    TVPFileReadError.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_FILE_READ_ERROR]);
    TVPInvalidPrerenderedFontFile.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_PRERENDERED_FONT_FILE]);
    TVPNot16BitUnicodeFontFile.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_NOT16BIT_UNICODE_FONT_FILE]);
    TVPInvalidHeaderVersion.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_HEADER_VERSION]);
    TVPTlgInsufficientMemory.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TLG_INSUFFICIENT_MEMORY]);
    TVPTlgTooLargeBitLength.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TLG_TOO_LARGE_BIT_LENGTH]);
    TVPCannotRetriveInterfaceFromDrawDevice.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_RETRIVE_INTERFACE_FROM_DRAW_DEVICE]);
    TVPScriptExceptionRaised.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_SCRIPT_EXCEPTION_RAISED]);
    TVPHardwareExceptionRaised.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_HARDWARE_EXCEPTION_RAISED]);
    TVPMainCDPName.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_MAIN_CDPNAME]);
    TVPExceptionCDPName.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_CDPNAME]);
    TVPCannnotLocateUIDLLForFolderSelection.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNNOT_LOCATE_UIDLLFOR_FOLDER_SELECTION]);
    ...
    TVPCannotLoadPlugin.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_LOAD_PLUGIN]);
    TVPNotValidPlugin.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_NOT_VALID_PLUGIN]);
    TVPPluginUninitFailed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_PLUGIN_UNINIT_FAILED]);
    TVPCannnotLinkPluginWhilePluginLinking.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNNOT_LINK_PLUGIN_WHILE_PLUGIN_LINKING]);
    TVPNotSusiePlugin.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_NOT_SUSIE_PLUGIN]);
    TVPSusiePluginError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_SUSIE_PLUGIN_ERROR]);
    TVPCannotReleasePlugin.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_RELEASE_PLUGIN]);
    TVPNotLoadedPlugin.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_NOT_LOADED_PLUGIN]);
    TVPCannotAllocateBitmapBits.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_ALLOCATE_BITMAP_BITS]);
    TVPScanLineRangeOver.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_SCAN_LINE_RANGE_OVER]);
    TVPPluginError.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_PLUGIN_ERROR]);
    TVPInvalidCDDADrive.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_CDDADRIVE]);
    TVPCDDADriveNotFound.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CDDADRIVE_NOT_FOUND]);
    ...
    TVPMalformedMIDIMessage.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_MALFORMED_MIDIMESSAGE]);
    TVPCannotInitDirectSound.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_INIT_DIRECT_SOUND]);
    TVPCannotCreateDSSecondaryBuffer.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_CREATE_DSSECONDARY_BUFFER]);
    TVPInvalidLoopInformation.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_LOOP_INFORMATION]);
    TVPNotChildMenuItem.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_NOT_CHILD_MENU_ITEM]);
    TVPCannotInitDirect3D.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_INIT_DIRECT3D]);
    TVPCannotFindDisplayMode.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_FIND_DISPLAY_MODE]);
    TVPCannotSwitchToFullScreen.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_SWITCH_TO_FULL_SCREEN]);
    TVPInvalidPropertyInFullScreen.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_PROPERTY_IN_FULL_SCREEN]);
    TVPInvalidMethodInFullScreen.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_METHOD_IN_FULL_SCREEN]);
    TVPCannotLoadCursor.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_LOAD_CURSOR]);
    TVPCannotLoadKrMovieDLL.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_LOAD_KR_MOVIE_DLL]);
    TVPInvalidKrMovieDLL.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_KR_MOVIE_DLL]);
    TVPErrorInKrMovieDLL.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_ERROR_IN_KR_MOVIE_DLL]);
    TVPWindowAlreadyMissing.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_WINDOW_ALREADY_MISSING]);
    TVPPrerenderedFontMappingFailed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_PRERENDERED_FONT_MAPPING_FAILED]);
    TVPConfigFailOriginalFileCannotBeRewritten.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_CONFIG_FAIL_ORIGINAL_FILE_CANNOT_BE_REWRITTEN]);
    TVPConfigFailTempExeNotErased.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CONFIG_FAIL_TEMP_EXE_NOT_ERASED]);
    TVPExecutionFail.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_EXECUTION_FAIL]);
    TVPPluginUnboundFunctionError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_PLUGIN_UNBOUND_FUNCTION_ERROR]);
    TVPExceptionHadBeenOccured.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_HAD_BEEN_OCCURED]);
    TVPConsoleResult.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_CONSOLE_RESULT]);
    TVPInfoListingFiles.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_LISTING_FILES]);
    TVPInfoTotalPhysicalMemory.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_TOTAL_PHYSICAL_MEMORY]);
    TVPInfoSelectedProjectDirectory.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_SELECTED_PROJECT_DIRECTORY]);
    TVPTooSmallExecutableSize.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TOO_SMALL_EXECUTABLE_SIZE]);
    TVPInfoLoadingExecutableEmbeddedOptionsFailed.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_INFO_LOADING_EXECUTABLE_EMBEDDED_OPTIONS_FAILED]);
    TVPInfoLoadingExecutableEmbeddedOptionsSucceeded.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_INFO_LOADING_EXECUTABLE_EMBEDDED_OPTIONS_SUCCEEDED]);
    TVPFileNotFound.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_FILE_NOT_FOUND]);
    TVPInfoLoadingConfigurationFileFailed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_LOADING_CONFIGURATION_FILE_FAILED]);
    TVPInfoLoadingConfigurationFileSucceeded.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_LOADING_CONFIGURATION_FILE_SUCCEEDED]);
    TVPInfoDataPathDoesNotExistTryingToMakeIt.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_INFO_DATA_PATH_DOES_NOT_EXIST_TRYING_TO_MAKE_IT]);
    ...
    TVPInfoSpecifiedOptionEarlierItemHasMorePriority.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_INFO_SPECIFIED_OPTION_EARLIER_ITEM_HAS_MORE_PRIORITY]);
    TVPNone.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_NONE]);
    TVPInfoCpuClockRoughly.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_CPU_CLOCK_ROUGHLY]);
    TVPProgramStartedOn.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_PROGRAM_STARTED_ON]);
    ...
    TVPEnableDigitizer.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_ENABLE_DIGITIZER]);
    TVPTouchIntegratedTouch.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TOUCH_INTEGRATED_TOUCH]);
    TVPTouchExternalTouch.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TOUCH_EXTERNAL_TOUCH]);
    TVPTouchIntegratedPen.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TOUCH_INTEGRATED_PEN]);
    TVPTouchExternalPen.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TOUCH_EXTERNAL_PEN]);
    TVPTouchMultiInput.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_TOUCH_MULTI_INPUT]);
    TVPTouchReady.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_TOUCH_READY]);
    TVPCpuCheckFailure.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CPU_CHECK_FAILURE]);
    TVPCpuCheckFailureCpuFamilyOrLesserIsNotSupported.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_CPU_CHECK_FAILURE_CPU_FAMILY_OR_LESSER_IS_NOT_SUPPORTED]);
    TVPInfoCpuNumber.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_INFO_CPU_NUMBER]);
    TVPCpuCheckFailureNotSupprtedCpu.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CPU_CHECK_FAILURE_NOT_SUPPRTED_CPU]);
    TVPInfoFinallyDetectedCpuFeatures.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_FINALLY_DETECTED_CPU_FEATURES]);
    TVPCpuCheckFailureNotSupportedCpu.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CPU_CHECK_FAILURE_NOT_SUPPORTED_CPU]);
    TVPInfoCpuClock.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_INFO_CPU_CLOCK]);
    TVPLayerBitmapBufferUnderrunDetectedCheckYourDrawingCode.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_LAYER_BITMAP_BUFFER_UNDERRUN_DETECTED_CHECK_YOUR_DRAWING_CODE]);
    TVPLayerBitmapBufferOverrunDetectedCheckYourDrawingCode.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_LAYER_BITMAP_BUFFER_OVERRUN_DETECTED_CHECK_YOUR_DRAWING_CODE]);
    TVPFaildToCreateDirect3D.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FAILD_TO_CREATE_DIRECT3D]);
    TVPFaildToDecideBackbufferFormat.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FAILD_TO_DECIDE_BACKBUFFER_FORMAT]);
    TVPFaildToCreateDirect3DDevice.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FAILD_TO_CREATE_DIRECT3DDEVICE]);
    TVPFaildToSetViewport.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FAILD_TO_SET_VIEWPORT]);
    TVPFaildToSetRenderState.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FAILD_TO_SET_RENDER_STATE]);
    TVPWarningImageSizeTooLargeMayBeCannotCreateTexture.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_WARNING_IMAGE_SIZE_TOO_LARGE_MAY_BE_CANNOT_CREATE_TEXTURE]);
    TVPUsePowerOfTwoSurface.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_USE_POWER_OF_TWO_SURFACE]);
    TVPCannotAllocateD3DOffScreenSurface.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_ALLOCATE_D3DOFF_SCREEN_SURFACE]);
    TVPBasicDrawDeviceFailedToCreateDirect3DDevices.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_BASIC_DRAW_DEVICE_FAILED_TO_CREATE_DIRECT3DDEVICES]);
    TVPBasicDrawDeviceFailedToCreateDirect3DDevicesUnknownReason.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_BASIC_DRAW_DEVICE_FAILED_TO_CREATE_DIRECT3DDEVICES_UNKNOWN_REASON]);
    TVPBasicDrawDeviceTextureHasAlreadyBeenLocked.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_BASIC_DRAW_DEVICE_TEXTURE_HAS_ALREADY_BEEN_LOCKED]);
    TVPInternalErrorResult.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INTERNAL_ERROR_RESULT]);
    TVPBasicDrawDeviceInfPolygonDrawingFailed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_BASIC_DRAW_DEVICE_INF_POLYGON_DRAWING_FAILED]);
    TVPBasicDrawDeviceInfDirect3DDevicePresentFailed.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_BASIC_DRAW_DEVICE_INF_DIRECT3DDEVICE_PRESENT_FAILED]);
    TVPChangeDisplaySettingsFailedDispChangeRestart.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_DISP_CHANGE_RESTART]);
    TVPChangeDisplaySettingsFailedDispChangeBadFlags.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_DISP_CHANGE_BAD_FLAGS]);
    TVPChangeDisplaySettingsFailedDispChangeBadParam.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_DISP_CHANGE_BAD_PARAM]);
    TVPChangeDisplaySettingsFailedDispChangeFailed.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_DISP_CHANGE_FAILED]);
    TVPChangeDisplaySettingsFailedDispChangeBadMode.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_DISP_CHANGE_BAD_MODE]);
    TVPChangeDisplaySettingsFailedDispChangeNotUpdated.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_DISP_CHANGE_NOT_UPDATED]);
    TVPChangeDisplaySettingsFailedUnknownReason.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_CHANGE_DISPLAY_SETTINGS_FAILED_UNKNOWN_REASON]);
    TVPFailedToCreateScreenDC.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FAILED_TO_CREATE_SCREEN_DC]);
    TVPFailedToCreateOffscreenBitmap.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FAILED_TO_CREATE_OFFSCREEN_BITMAP]);
    TVPFailedToCreateOffscreenDC.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_FAILED_TO_CREATE_OFFSCREEN_DC]);
    TVPInfoSusiePluginInfo.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_SUSIE_PLUGIN_INFO]);
    TVPSusiePluginUnsupportedBitmapHeader.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_SUSIE_PLUGIN_UNSUPPORTED_BITMAP_HEADER]);
    TVPBasicDrawDeviceFailedToCreateDirect3DDevice.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_BASIC_DRAW_DEVICE_FAILED_TO_CREATE_DIRECT3DDEVICE]);
    TVPBasicDrawDeviceFailedToCreateDirect3DDeviceUnknownReason.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_BASIC_DRAW_DEVICE_FAILED_TO_CREATE_DIRECT3DDEVICE_UNKNOWN_REASON]);
    TVPCouldNotCreateAnyDrawDevice.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_COULD_NOT_CREATE_ANY_DRAW_DEVICE]);
    TVPBasicDrawDeviceDoesNotSupporteLayerManagerMoreThanOne.AssignMessage(
        RESOURCE_MESSAGE
            [NUM_TVP_BASIC_DRAW_DEVICE_DOES_NOT_SUPPORTE_LAYER_MANAGER_MORE_THAN_ONE]);
    TVPInvalidVideoSize.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INVALID_VIDEO_SIZE]);
    TVPRoughVsyncIntervalReadFromApi.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_ROUGH_VSYNC_INTERVAL_READ_FROM_API]);
    TVPRoughVsyncIntervalStillSeemsWrong.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_ROUGH_VSYNC_INTERVAL_STILL_SEEMS_WRONG]);
    TVPInfoFoundDirect3DInterface.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_FOUND_DIRECT3DINTERFACE]);
    ...
    TVPCannotLoadD3DDLL.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_LOAD_D3DDLL]);
    TVPNotFoundDirect3DCreate.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_NOT_FOUND_DIRECT3DCREATE]);
    TVPInfoEnvironmentUsing.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_ENVIRONMENT_USING]);
    TVPInfoSearchBestFullscreenResolution.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_SEARCH_BEST_FULLSCREEN_RESOLUTION]);
    TVPInfoConditionPreferredScreenMode.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_CONDITION_PREFERRED_SCREEN_MODE]);
    TVPInfoConditionMode.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_CONDITION_MODE]);
    TVPInfoConditionZoomMode.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_CONDITION_ZOOM_MODE]);
    TVPInfoEnvironmentDefaultScreenMode.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_ENVIRONMENT_DEFAULT_SCREEN_MODE]);
    TVPInfoEnvironmentDefaultScreenAspectRatio.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_ENVIRONMENT_DEFAULT_SCREEN_ASPECT_RATIO]);
    TVPInfoEnvironmentAvailableDisplayModes.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_ENVIRONMENT_AVAILABLE_DISPLAY_MODES]);
    TVPInfoNotFoundScreenModeFromDriver.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_NOT_FOUND_SCREEN_MODE_FROM_DRIVER]);
    TVPInfoResultCandidates.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_RESULT_CANDIDATES]);
    TVPInfoTryScreenMode.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_TRY_SCREEN_MODE]);
    TVPAllScreenModeError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_ALL_SCREEN_MODE_ERROR]);
    TVPInfoChangeScreenModeSuccess.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_INFO_CHANGE_SCREEN_MODE_SUCCESS]);
    TVPSelectXP3FileOrFolder.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_SELECT_XP3FILE_OR_FOLDER]);
    TVPD3dErrDeviceLost.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_DEVICE_LOST]);
    TVPD3dErrDriverIinternalError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_DRIVER_IINTERNAL_ERROR]);
    TVPD3dErrInvalidCall.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_INVALID_CALL]);
    TVPD3dErrOutOfVideoMemory.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_OUT_OF_VIDEO_MEMORY]);
    TVPD3dErrOutOfMemory.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_OUT_OF_MEMORY]);
    TVPD3dErrWrongTextureFormat.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_WRONG_TEXTURE_FORMAT]);
    TVPD3dErrUnsuportedColorOperation.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_UNSUPORTED_COLOR_OPERATION]);
    TVPD3dErrUnsuportedColorArg.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_UNSUPORTED_COLOR_ARG]);
    TVPD3dErrUnsuportedAalphtOperation.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_UNSUPORTED_AALPHT_OPERATION]);
    TVPD3dErrUnsuportedAlphaArg.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_UNSUPORTED_ALPHA_ARG]);
    TVPD3dErrTooManyOperations.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_TOO_MANY_OPERATIONS]);
    TVPD3dErrConflictioningTextureFilter.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_CONFLICTIONING_TEXTURE_FILTER]);
    TVPD3dErrUnsuportedFactorValue.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_UNSUPORTED_FACTOR_VALUE]);
    TVPD3dErrConflictioningRenderState.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_CONFLICTIONING_RENDER_STATE]);
    TVPD3dErrUnsupportedTextureFilter.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_UNSUPPORTED_TEXTURE_FILTER]);
    TVPD3dErrConflictioningTexturePalette.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_CONFLICTIONING_TEXTURE_PALETTE]);
    TVPD3dErrNotFound.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_NOT_FOUND]);
    TVPD3dErrMoreData.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_MORE_DATA]);
    TVPD3dErrDeviceNotReset.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_DEVICE_NOT_RESET]);
    TVPD3dErrNotAvailable.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_NOT_AVAILABLE]);
    TVPD3dErrInvalidDevice.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_INVALID_DEVICE]);
    TVPD3dErrDriverInvalidCall.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_DRIVER_INVALID_CALL]);
    TVPD3dErrWasStillDrawing.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_WAS_STILL_DRAWING]);
    TVPD3dErrDeviceHung.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_DEVICE_HUNG]);
    TVPD3dErrUnsupportedOverlay.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_UNSUPPORTED_OVERLAY]);
    TVPD3dErrUnsupportedOverlayFormat.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_UNSUPPORTED_OVERLAY_FORMAT]);
    TVPD3dErrCannotProtectContent.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_CANNOT_PROTECT_CONTENT]);
    TVPD3dErrUnsupportedCrypto.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_UNSUPPORTED_CRYPTO]);
    TVPD3dErrPresentStatisticsDisJoint.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_PRESENT_STATISTICS_DIS_JOINT]);
    TVPD3dErrDeviceRemoved.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_DEVICE_REMOVED]);
    TVPD3dOkNoAutoGen.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_OK_NO_AUTO_GEN]);
    TVPD3dErrFail.AssignMessage(RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_FAIL]);
    TVPD3dErrInvalidArg.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_ERR_INVALID_ARG]);
    TVPD3dUnknownError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_D3D_UNKNOWN_ERROR]);
    TVPExceptionAccessViolation.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_ACCESS_VIOLATION]);
    TVPExceptionBreakpoint.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_BREAKPOINT]);
    TVPExceptionDatatypeMisalignment.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_DATATYPE_MISALIGNMENT]);
    TVPExceptionSingleStep.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_SINGLE_STEP]);
    TVPExceptionArrayBoundsExceeded.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_ARRAY_BOUNDS_EXCEEDED]);
    TVPExceptionFltDenormalOperand.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_FLT_DENORMAL_OPERAND]);
    TVPExceptionFltDivideByZero.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_FLT_DIVIDE_BY_ZERO]);
    TVPExceptionFltInexactResult.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_FLT_INEXACT_RESULT]);
    TVPExceptionFltInvalidOperation.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_FLT_INVALID_OPERATION]);
    TVPExceptionFltOverflow.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_FLT_OVERFLOW]);
    TVPExceptionFltStackCheck.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_FLT_STACK_CHECK]);
    TVPExceptionFltUnderflow.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_FLT_UNDERFLOW]);
    TVPExceptionIntDivideByZero.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_INT_DIVIDE_BY_ZERO]);
    TVPExceptionIntOverflow.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_INT_OVERFLOW]);
    TVPExceptionPrivInstruction.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_PRIV_INSTRUCTION]);
    TVPExceptionNoncontinuableException.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_NONCONTINUABLE_EXCEPTION]);
    TVPExceptionGuardPage.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_GUARD_PAGE]);
    TVPExceptionIllegalInstruction.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_ILLEGAL_INSTRUCTION]);
    TVPExceptionInPageError.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_IN_PAGE_ERROR]);
    TVPExceptionInvalidDisposition.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_INVALID_DISPOSITION]);
    TVPExceptionInvalidHandle.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_INVALID_HANDLE]);
    TVPExceptionStackOverflow.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_STACK_OVERFLOW]);
    TVPExceptionUnwindCconsolidate.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_EXCEPTION_UNWIND_CCONSOLIDATE]);
    TVPCannotShowModalAreadyShowed.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_SHOW_MODAL_AREADY_SHOWED]);
    TVPCannotShowModalSingleWindow.AssignMessage(
        RESOURCE_MESSAGE[NUM_TVP_CANNOT_SHOW_MODAL_SINGLE_WINDOW]);
}
...
static tTVPAtExit TVPUninitMessageLoad(TVP_ATEXIT_PRI_RELEASE, TVPFreeMessages);
