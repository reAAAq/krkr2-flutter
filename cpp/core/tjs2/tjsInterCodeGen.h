...
public:
    ...
    void Disassemble(void (*output_func)(const tjs_char *msg,
                                         ...
                                         tjs_int size, void *data),
                     void (*output_func_src)(const tjs_char *msg,
...
public:
    ...
    tTJSInterCodeContext(tTJSScriptBlock *block, const tjs_char *name,
                         ...
                         tjs_int codeSize, tTJSVariant *data, tjs_int dataSize,
                         tjs_int varcount, tjs_int verrescount,
                         tjs_int maxframe, tjs_int argcount, tjs_int arraybase,
                         tjs_int colbase, bool srcsorted, tSourcePos *srcPos,
                         tjs_int srcPosSize,
