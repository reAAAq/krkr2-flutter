...
public:
    ...
    virtual ttstr GetFontName() const;
    ...
    virtual tjs_int GetOpacity() const;

    virtual void SetOpacity(tjs_int opa);

    virtual bool GetStatusBarVisible() const;

    virtual void SetStatusBarVisible(bool vis);

    virtual tjs_int GetScrollBarsVisible() const;

    virtual void SetScrollBarsVisible(tjs_int vis);

    virtual tjs_int GetBorderStyle() const;
    ...
    virtual tjs_int GetFormHeight() const;

    virtual tjs_int GetFormWidth() const;

    virtual tjs_int GetFormTop() const;

    virtual tjs_int GetFormLeft() const;
