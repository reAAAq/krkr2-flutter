...
public:
    ...
    */
    ...
    static inline void PutString(tTJSBinaryStream *stream, const tjs_char *val,
                                 tjs_uint len) {
    ...
    static inline void PutBytes(tTJSBinaryStream *stream, const tjs_uint8 *val,
                                tjs_uint len) {
    ...
    static inline tTJSVariant *ReadOctetVarint(const tjs_uint8 *buff,
                                               tjs_uint len, tjs_uint &index) {
...
private:
    ...
    void AddDictionary(class tTJSDictionaryObject *dic, tTJSVariantString *name,
                       tTJSVariant *value);
