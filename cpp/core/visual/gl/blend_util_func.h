...
/* struct add_aldpha_blend_n_a_o_func {	// TVPAddAlphaBlend_n_a_o
        add_aldpha_blend_n_a_func add_alpha_;
        inline tjs_uint32 operator()( tjs_uint32 d, tjs_uint32 s, tjs_int opa )
const { s = (((s & 0xff00ff)*opa >> 8) & 0xff00ff) + (((s >> 8) & 0xff00ff)*opa
...
/* struct add_alpha_blend_hda_n_a_o_func {	// TVPAddAlphaBlend_HDA_n_a_o
        ...
        inline tjs_uint32 operator()( tjs_uint32 d, tjs_uint32 s, tjs_int opa )
const { return (d & 0xff000000) + (add_alpha_(d, s, opa) & 0xffffff);
        }
};*/
