...
// inline TJS_EXP_FUNC_DEF(void *, TVP_realloc, (void *pp, size_t size)) {
...
// 'finallyblock' can be nullptr, is to be executed whatever the exception
// is generated or not.
...
// TJS_EXP_FUNC_DEF(bool, TVPGetFileVersionOf, (const wchar_t* module_filename,
