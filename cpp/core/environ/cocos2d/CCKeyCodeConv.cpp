...
#define CASE(x) { #x, VK_##x }
        CASE(0), CASE(1), CASE(2), CASE(3), CASE(4), CASE(5), CASE(6), CASE(7),
            CASE(8), CASE(9), CASE(A), CASE(B), CASE(C), CASE(D), CASE(E),
            ...
            CASE(PAUSE), CASE(PRINT), CASE(ESCAPE), CASE(TAB), CASE(RETURN),
            CASE(SCROLL), CASE(SNAPSHOT), CASE(CANCEL), CASE(BACK),
            CASE(CAPITAL), CASE(SHIFT), CASE(CONTROL), CASE(MENU), CASE(APPS),
            CASE(LWIN), CASE(INSERT), CASE(HOME), CASE(DELETE), CASE(END),
            CASE(PRIOR), CASE(NEXT), CASE(LEFT), CASE(RIGHT), CASE(UP),
            CASE(DOWN), CASE(NUMLOCK), CASE(ADD), CASE(SUBTRACT),
            CASE(MULTIPLY), CASE(DIVIDE), CASE(HOME), CASE(NUMPAD5), CASE(END),
            CASE(INSERT), CASE(DELETE), CASE(SPACE), CASE(OEM_COMMA),
            CASE(OEM_MINUS), CASE(OEM_PERIOD), CASE(OEM_PLUS), CASE(OEM_1),
            CASE(OEM_2), CASE(OEM_4), CASE(OEM_5), CASE(OEM_6), CASE(OEM_7),
            CASE(PLAY),
#undef CASE
    });
    return ret;
