...
tTVPCommandOptionList *TVPGetPluginCommandDesc(const wchar_t *name) {
    ...
    unsigned int size = 0;
    tTVPCommandOptionList *ret = nullptr;
    try {
        // BOOL typeret = ::EnumResourceTypes( hModule,
        // (ENUMRESTYPEPROC)EnumResTypeProc,  nullptr ); BOOL resret =
        // ::EnumResourceNames( hModule, L"TEXT",
