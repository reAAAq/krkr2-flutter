...
void tTVPCharacterData::Expand() {
    if (FullColored)
        TVPThrowExceptionMessage(
            TJS_W("unimplemented: tTVPCharacterData::Expand for FullColored"));
...
void tTVPCharacterData::Blur(tjs_int blurlevel, tjs_int blurwidth) {
    if (FullColored)
        TVPThrowExceptionMessage(
            TJS_W("unimplemented: tTVPCharacterData::Blur for FullColored"));
...
void tTVPCharacterData::Bold(tjs_int size) {
    if (FullColored)
        TVPThrowExceptionMessage(
            TJS_W("unimplemented: tTVPCharacterData::Bold for FullColored"));
...
void tTVPCharacterData::Bold2(tjs_int size) {
    if (FullColored)
        TVPThrowExceptionMessage(
            TJS_W("unimplemented: tTVPCharacterData::Bold2 for FullColored"));
...
void tTVPCharacterData::Resample4() {
    if (FullColored)
        TVPThrowExceptionMessage(TJS_W(
            "unimplemented: tTVPCharacterData::Resample4 for FullColored"));
...
void tTVPCharacterData::Resample8() {
    if (FullColored)
        TVPThrowExceptionMessage(TJS_W(
            "unimplemented: tTVPCharacterData::Resample8 for FullColored"));
