...
// 汎用イテレータ参照
template <typename Iterator> class IteratorData : public IteratorBase {
public:
...
template <typename Iterator> struct HeaderParser : qi::grammar<Iterator> {
    HeaderParser(Header &data) : HeaderParser::base_type(start), data(data) {
        start =
            (qi::lit("8BPS") >> qi::big_word >> repos::qi::advance(6) >>
             qi::big_word >> qi::big_dword >> qi::big_dword >> qi::big_word >>
             qi::big_word)[phx::bind(&HeaderParser::setHeader, this, qi::_1,
                                     qi::_2, qi::_3, qi::_4, qi::_5, qi::_6)];
    }

    void setHeader(int version, int channels, int height, int width, int depth,
                   int mode) {
    ...
    ImageResourceParser(Data &data)
        ...
        anImageResource =
            (qi::lit("8BIM") >>                   // signature
             ...
             )[phx::bind(&ImageResourceParser::addImageResource, this, qi::_1,
                         qi::_3, qi::_5, qi::_6)];
 ...
 * レイヤ extra data パーサ
 */
template <typename Iterator> struct LayerMaskParser : qi::grammar<Iterator> {
    ...
    LayerMaskParser(LayerMask &data, int size)
        ...
        start =
            (qi::big_dword >> qi::big_dword >> qi::big_dword >> qi::big_dword >>
             qi::byte_ >> qi::byte_ >>
             qi::byte_)[phx::bind(&LayerMaskParser::setLayerMask, this, qi::_1,
                                  qi::_2, qi::_3, qi::_4, qi::_5, qi::_6)];

        if (size > 20) {
            start = (start.copy() >> qi::byte_ >> qi::byte_ >> qi::big_dword >>
                     qi::big_dword >> qi::big_dword >> qi::big_dword)[phx::bind(
                &LayerMaskParser::setLayerMaskExtra, this, qi::_1, qi::_2,
                qi::_3, qi::_4, qi::_5, qi::_6)];
        }
    }
...
struct LayerExtraDataParser : qi::grammar<Iterator> {
    ...
    LayerExtraDataParser(LayerExtraData &data)
        ...
        layerBlendingRange = (qi::big_dword[qi::_a = qi::_1] >>
                              qi::raw[repos::qi::advance(qi::_a)])[phx::bind(
 ...
 * レイヤ情報パーサ
 */
template <typename Iterator> struct LayerInfoParser : qi::grammar<Iterator> {
    ...
    LayerInfoParser(Data &data)
        ...
        layerRecord =
            (qi::eps[phx::bind(&LayerInfoParser::addLayer, this)] >>
             ...
             qi::big_dword >> // bottom
             qi::big_dword    // right
             )[phx::bind(&LayerInfoParser::setLayerSize, this, qi::_1, qi::_2,
                         qi::_3, qi::_4)] >>
            ...
            (qi::big_dword >>                      // blend mode key
             ...
             qi::byte_ >>                          // clipping
             qi::byte_                             // flag
             )[phx::bind(&LayerInfoParser::setLayerData, this, qi::_1, qi::_2,
                         qi::_3, qi::_4)] >>
            qi::byte_ >> // filler(zero)
            extraData;
        // パース開始部
        start = (qi::big_word[phx::bind(&LayerInfoParser::setLayerCount, this,
                                        qi::_1)] >>
                 layerRecords >>
...
struct GlobalLayerMaskInfoParser : qi::grammar<Iterator> {
    GlobalLayerMaskInfoParser(GlobalLayerMaskInfo &data)
        ...
        start =
            (qi::big_word >> qi::big_word >> qi::big_word >> qi::big_word >>
             qi::big_word >> qi::big_word >> qi::byte_ >> *qi::byte_)[phx::bind(
 ...
 */
template <typename Iterator> struct LayerAndMaskParser : qi::grammar<Iterator> {
    ...
    LayerAndMaskParser(Data &data)
        ...
        globalLayerMaskInfo = (qi::big_dword[qi::_a = qi::_1] >>   // size
            ...
            &LayerAndMaskParser::setGlobalLayerMaskInfo, this, qi::_1, qi::_2)];
...
template <typename Iterator> struct Parser : qi::grammar<Iterator> {
    ...
    Parser(Data &data)
        ...
        // 画像データ
        imageData =
            qi::raw[+qi::byte_][phx::bind(&Parser::setImageData, this, qi::_1)];

        start = headerParser >> colorMode >> imageResource >> layerAndMask >>
                -imageData >> qi::eoi;
    }
