...
template <typename ObjT> class tVoidObjectList {
private:
    ObjT **Objects;
...
template <typename ObjT> class tObjectList {
private:
...
//---------------------------------------------------------------------------
template <typename ObjT> class tVoidObjectListSafeLockHolder {
private:
    tVoidObjectList<ObjT> &List;
...
//---------------------------------------------------------------------------
template <typename ObjT> class tObjectListSafeLockHolder {
private:
