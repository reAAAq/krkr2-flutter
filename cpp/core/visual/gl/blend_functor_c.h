 ...
 * alpha_blend_HDA_o_functor;	// dstアルファ無視, dst アルファ保護, opacity
 * 指定
 *
...
struct premulalpha_blend_func {
        ...
        inline tjs_uint32 operator()( tjs_uint32 d, tjs_uint32 s, tjs_uint32 a )
const { s = (((s & 0xff00ff)*a >> 8) & 0xff00ff) + (((s >> 8) & 0xff00ff)*a &
0xff00ff00); return add_alpha_(d, s);
        }
};
...
struct premulalpha_blend_HDA_o_functor : public premulalpha_blend_o_functor {
        inline premulalpha_blend_HDA_o_functor( tjs_int opa ) :
premulalpha_blend_o_functor(opa) {} inline tjs_uint32 operator()( tjs_uint32 d,
tjs_uint32 s ) const { return (premulalpha_blend_o_functor::operator()(d,
s)&0x00ffffff) | (d&0xff000000);
        }
};
*/
...
//--------------------------------------------------------------------------------------------------------
template <int tshift> struct apply_color_map_xx_functor {
    const tjs_uint32 color_;
...
template <typename tbase> struct apply_color_map_xx_o_functor : tbase {
    tjs_int opa_;
...
template <int tshift> struct apply_color_map_xx_HDA_functor {
    const tjs_uint32 color_;
    const tjs_uint32 c1_;
...
template <int tshift> struct apply_color_map_xx_a_functor {
    const tjs_uint32 color_;
    const tjs_uint32 c1_;
...
template <int tmax, int tshift> struct remove_opacity_xx_functor {
    inline tjs_uint32 operator()(tjs_uint32 d, tjs_uint8 s) const {
        return (d & 0xffffff) +
               ((((d >> 24) * (tmax - s)) << tshift) & 0xff000000);
    }
};
template <int tmax, int tshift> struct remove_opacity_xx_o_functor {
    const tjs_int opa_;
...
//--------------------------------------------------------------------------------------------------------
template <int tmax> struct ch_blur_mul_copy_xx_functor {
...
template <int tmax> struct ch_blur_add_mul_copy_xx_functor {
    const tjs_int level_;
