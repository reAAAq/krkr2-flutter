...
public:
    ...
    RegisterLayerManager(class iTVPLayerManager *manager) = 0;
    virtual void TJS_INTF_METHOD
    UnregisterLayerManager(class iTVPLayerManager *manager) = 0;
    ...
    virtual void TJS_INTF_METHOD NotifyBitmapCompleted(
        ...
        class tTVPBaseTexture *bmp, const struct tTVPRect &cliprect,
        enum tTVPLayerType type, tjs_int opacity) = 0;
    virtual void TJS_INTF_METHOD
    ...
    virtual void TJS_INTF_METHOD SetCursorPos(class iTVPLayerManager *manager,
                                              tjs_int x, tjs_int y) = 0;
    virtual void TJS_INTF_METHOD
    ReleaseMouseCapture(class iTVPLayerManager *manager) = 0;
    ...
    virtual void TJS_INTF_METHOD
    NotifyLayerResize(class iTVPLayerManager *manager) = 0;
    virtual void TJS_INTF_METHOD
    NotifyLayerImageChange(class iTVPLayerManager *manager) = 0;

    virtual void TJS_INTF_METHOD
    SetAttentionPoint(class iTVPLayerManager *manager,
                      class tTJSNI_BaseLayer *layer, tjs_int x, tjs_int y) = 0;
    virtual void TJS_INTF_METHOD
    DisableAttentionPoint(class iTVPLayerManager *manager) = 0;

    virtual void TJS_INTF_METHOD
    SetImeMode(class iTVPLayerManager *manager,
               tjs_int mode) = 0; // mode == tTVPImeMode
    virtual void TJS_INTF_METHOD
    ResetImeMode(class iTVPLayerManager *manager) = 0;
