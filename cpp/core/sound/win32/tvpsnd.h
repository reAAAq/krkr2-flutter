...
typedef struct ITSSModuleVtbl {
    ...
    ULONG(STDMETHODCALLTYPE __RPC_FAR *AddRef)(ITSSModule __RPC_FAR *This);

    ULONG(STDMETHODCALLTYPE __RPC_FAR *Release)(ITSSModule __RPC_FAR *This);
...
typedef struct ITSSWaveDecoderVtbl {
    ...
    ULONG(STDMETHODCALLTYPE __RPC_FAR *AddRef)(ITSSWaveDecoder __RPC_FAR *This);
