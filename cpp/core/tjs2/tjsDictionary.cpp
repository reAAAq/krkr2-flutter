...
tTJSDictionaryClass::tTJSDictionaryClass()
        ...
        try {
            ...
            if (streamlen >= tTJSBinarySerializer::HEADER_LENGTH) {
                ...
                if (tTJSBinarySerializer::IsBinary(header)) {
                    if (!dic)
                        dic =
                            (tTJSDictionaryObject *)TJSCreateDictionaryObject();
    ...
    TJS_BEGIN_NATIVE_METHOD_DECL(/*func.name*/ saveStruct) {
        ...
        // the content can be interpret as an expression to re-construct the
        // object.
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDictionaryClass::CreateNew(
    ...
    if (dsp && TJS_SUCCEEDED(dsp->NativeInstanceSupport(
        ...
        for (i = arrayni->Items.begin(); i != arrayni->Items.end(); i++) {
            ...
            if (arrayni->Items.end() == i)
                break;
            Owner->PropSetByVS(TJS_MEMBERENSURE | TJS_IGNOREPROP, name, &(*i),
                               Owner);
        }
    } else {
        // otherwise
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDictionaryNI::tAssignCallback::FuncCall(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
...
tjs_error TJS_INTF_METHOD tTJSDictionaryNI::tSaveStructBinayCallback::FuncCall(
    ...
    if (type == tvtObject) {
        // object
        tTJSVariantClosure clo = param[2]->AsObjectClosureNoAddRef();
        tTJSArrayNI::SaveStructuredBinaryForObject(clo.SelectObjectNoAddRef(),
                                                   *Stack, *Stream);
    } else {
...
void tTJSDictionaryNI::AssignStructure(iTJSDispatch2 *dsp,
    ...
    if (TJS_SUCCEEDED(
            dsp->NativeInstanceSupport(TJS_NIS_GETINSTANCE, ClassID_Dictionary,
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDictionaryObject::FuncCall(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
    tTJSVariant *result, tjs_int numparams, tTJSVariant **param,
    iTJSDispatch2 *objthis) {
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDictionaryObject::PropGet(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDictionaryObject::CreateNew(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
    iTJSDispatch2 **result, tjs_int numparams, tTJSVariant **param,
    iTJSDispatch2 *objthis) {
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDictionaryObject::Operation(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
    ...
    if (hr == TJS_E_MEMBERNOTFOUND && !(flag & TJS_MEMBERMUSTEXIST)) {
        ...
        hr = inherited::PropSet(TJS_MEMBERENSURE, membername, hint, &VoidVal,
                                objthis);
        if (TJS_FAILED(hr))
            return hr;
...
iTJSDispatch2 *TJSCreateDictionaryObject(iTJSDispatch2 **classout) {
    ...
    (dictionaryclass.Obj)
        ->CreateNew(0, nullptr, nullptr, (iTJSDispatch2 **)&dictionaryobj, 0,
                    nullptr, dictionaryclass.Obj);
