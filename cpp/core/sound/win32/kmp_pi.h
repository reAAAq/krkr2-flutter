...
typedef struct {
    ...
    //が期待する値と一致しない場合は、KbMedia Player によって直ちに FreeLibrary
    //が呼ばれる。 その場合、InitDll() も DeinitDll() も呼ばれないことに注意。
    ...
    //サポートしないからといって、常に nullptr を返すように実装してはならない。
