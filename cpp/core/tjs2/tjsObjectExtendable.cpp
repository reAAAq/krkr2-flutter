...
tjs_error TJS_INTF_METHOD tTJSExtendableObject::FuncCall(
...
tjs_error TJS_INTF_METHOD tTJSExtendableObject::CreateNew(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
    ...
    if (hr == TJS_E_MEMBERNOTFOUND && SuperClass != nullptr &&
        membername != nullptr) {
        hr = SuperClass->CreateNew(flag, membername, hint, result, numparams,
                                   param, objthis);
    }
    return hr;
}

tjs_error TJS_INTF_METHOD tTJSExtendableObject::PropGet(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
...
tjs_error TJS_INTF_METHOD tTJSExtendableObject::PropSet(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
...
tjs_error TJS_INTF_METHOD tTJSExtendableObject::IsInstanceOf(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
...
tTJSExtendableObject::GetCount(tjs_int *result, const tjs_char *membername,
...
tjs_error TJS_INTF_METHOD
tTJSExtendableObject::DeleteMember(tjs_uint32 flag, const tjs_char *membername,
                                   tjs_uint32 *hint, iTJSDispatch2 *objthis) {
...
tjs_error TJS_INTF_METHOD
tTJSExtendableObject::Invalidate(tjs_uint32 flag, const tjs_char *membername,
                                 tjs_uint32 *hint, iTJSDispatch2 *objthis) {
...
tjs_error TJS_INTF_METHOD
tTJSExtendableObject::IsValid(tjs_uint32 flag, const tjs_char *membername,
                              tjs_uint32 *hint, iTJSDispatch2 *objthis) {
...
tjs_error TJS_INTF_METHOD tTJSExtendableObject::Operation(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
    tTJSVariant *result, const tTJSVariant *param, iTJSDispatch2 *objthis) {
    tjs_error hr =
        inherited::Operation(flag, membername, hint, result, param, objthis);
    if (hr == TJS_E_MEMBERNOTFOUND && SuperClass != nullptr &&
        membername != nullptr) {
...
tjs_error TJS_INTF_METHOD tTJSExtendableObject::NativeInstanceSupport(
...
tjs_error TJS_INTF_METHOD tTJSExtendableObject::ClassInstanceInfo(
