...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDispatch::FuncCallByNum(
    tjs_uint32 flag, tjs_int num, tTJSVariant *result, tjs_int numparams,
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDispatch::PropGetByNum(tjs_uint32 flag,
                                                     tjs_int num,
                                                     tTJSVariant *result,
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDispatch::PropSetByNum(tjs_uint32 flag,
                                                     tjs_int num,
                                                     const tTJSVariant *param,
                                                     iTJSDispatch2 *objthis) {
    tjs_char buf[34];
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDispatch::GetCountByNum(tjs_int *result,
                                                      tjs_int num,
                                                      iTJSDispatch2 *objthis) {
    tjs_char buf[34];
    TJS_int_to_str(num, buf);
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDispatch::DeleteMemberByNum(
    tjs_uint32 flag, tjs_int num, iTJSDispatch2 *objthis) {
    tjs_char buf[34];
    TJS_int_to_str(num, buf);
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDispatch::InvalidateByNum(
    tjs_uint32 flag, tjs_int num, iTJSDispatch2 *objthis) {
    tjs_char buf[34];
    TJS_int_to_str(num, buf);
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDispatch::IsValidByNum(tjs_uint32 flag,
                                                     tjs_int num,
                                                     iTJSDispatch2 *objthis) {
    tjs_char buf[34];
    TJS_int_to_str(num, buf);
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDispatch::CreateNewByNum(
    tjs_uint32 flag, tjs_int num, iTJSDispatch2 **result, tjs_int numparams,
    tTJSVariant **param, iTJSDispatch2 *objthis) {
    tjs_char buf[34];
    TJS_int_to_str(num, buf);
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDispatch::IsInstanceOfByNum(
    tjs_uint32 flag, tjs_int num, const tjs_char *classname,
    iTJSDispatch2 *objthis) {
    tjs_char buf[34];
    TJS_int_to_str(num, buf);
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDispatch::OperationByNum(tjs_uint32 flag,
                                                       tjs_int num,
                                                       tTJSVariant *result,
                                                       const tTJSVariant *param,
                                                       iTJSDispatch2 *objthis) {
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSDispatch::Operation(
...
void tTJSCustomObject::Finalize() {
    ...
    if (CallFinalize) {
        FuncCall(0, finalize_name.c_str(), finalize_name.GetHint(), nullptr, 0,
                 nullptr, this);
    }
...
tTJSCustomObject::Add(tTJSVariantString *name) {
    ...
    tjs_uint32 hash;
    if (*(name->GetHint()))
        hash = *(name->GetHint()); // hint must be hash because of previous
                                   // calling of "Find"
    else
        ...
        for (; lv1 < lv1lim; lv1++) {
            ...
            if (lv1->SymFlags & TJS_SYMBOL_USING) {
                ...
                if (data) {
                    ...
                    data->SymFlags |=
                        lv1->SymFlags & (TJS_SYMBOL_HIDDEN | TJS_SYMBOL_STATIC);
                    CheckObjectClosureAdd(GetValue(data));
                }
            }
        }
        ...
        for (; lv1 < lv1lim; lv1++) {
            ...
            if (lv1->SymFlags & TJS_SYMBOL_USING) {
                if (((tTJSVariant *)(&(lv1->Value)))->Type() == tvtObject) {
                    CheckObjectClosureRemove(*(tTJSVariant *)(&(lv1->Value)));
                    tTJSVariantClosure clo = ((tTJSVariant *)(&(lv1->Value)))
                                                 ->AsObjectClosureNoAddRef();
                    clo.AddRef();
                    if (clo.Object)
                        vector.push_back(clo.Object);
...
tTJSCustomObject::tTJSSymbolData *tTJSCustomObject::Find(const tjs_char *name,
    ...
    if (!(lv1->SymFlags & TJS_SYMBOL_USING) && lv1->Next == nullptr)
        return nullptr; // lv1 is unused and does not have any chains
...
bool tTJSCustomObject::CallEnumCallbackForData(
    ...
    *params[1] = (tjs_int)newflags;
    ...
    if (!(flags & TJS_ENUM_NO_VALUE)) {
        // get value
        if (TJS_FAILED(TJSDefaultPropGet(
                flags, *(tTJSVariant *)(&(data->Value)), params[2], objthis)))
            return false;
    }
...
void tTJSCustomObject::InternalEnumMembers(tjs_uint32 flags,
    ...
    // note that member changes(delete or insert) through this function is not
    // guaranteed.
    if (!callback)
        return;
...
tjs_error TJSTryFuncCallViaPropGet(tTJSVariantClosure tvclosure,
    ...
    tjs_error er;
    try {
        er = tvclosure.Object->PropGet(0, nullptr, nullptr, &tmp,
    ...
    if (TJS_SUCCEEDED(er)) {
        ...
        er = tvclosure.Object->FuncCall(flag, nullptr, nullptr, result,
                                        numparams, param,
                                        TJS_SELECT_OBJTHIS(tvclosure, objthis));
        tvclosure.Release();
    }
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSCustomObject::FuncCall(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
    ...
    if (!data) {
        if (CallMissing) {
            ...
            if (CallGetMissing(membername, value_func))
                return TJSDefaultFuncCall(flag, value_func, result, numparams,
                                          param, objthis);
        }
    ...
    return TJSDefaultFuncCall(flag, GetValue(data), result, numparams, param,
                              objthis);
}
...
tjs_error TJSDefaultPropGet(tjs_uint32 flag, tTJSVariant &targ,
    ...
    if (!(flag & TJS_IGNOREPROP)) {
        ...
        // if member's type is tvtObject, call the object's PropGet with
        // "member=nullptr"
        //  ( default member invocation ). if it is succeeded, return its return
        //  value.
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSCustomObject::PropGet(tjs_uint32 flag,
                                                    const tjs_char *membername,
                                                    tjs_uint32 *hint,
                                                    tTJSVariant *result,
                                                    iTJSDispatch2 *objthis) {
    ...
    if (membername == nullptr) {
        // this object itself has no information on PropGet with membername ==
        // nullptr
        return TJS_E_INVALIDTYPE;
    }
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSCustomObject::PropSet(tjs_uint32 flag,
                                                    const tjs_char *membername,
                                                    tjs_uint32 *hint,
                                                    const tTJSVariant *param,
                                                    iTJSDispatch2 *objthis) {
    ...
    if (flag & TJS_MEMBERENSURE)
        data = Add(membername,
                   hint); // create a member when TJS_MEMBERENSURE is specified
    else
        data = Find(membername, hint);
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSCustomObject::GetCount(tjs_int *result,
                                                     const tjs_char *membername,
                                                     tjs_uint32 *hint,
                                                     iTJSDispatch2 *objthis) {
    if (!GetValidity())
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSCustomObject::PropSetByVS(
    tjs_uint32 flag, tTJSVariantString *membername, const tTJSVariant *param,
    iTJSDispatch2 *objthis) {
    if (!GetValidity())
        return TJS_E_INVALIDOBJECT;
    ...
    if (flag & TJS_MEMBERENSURE)
        data = Add(
            membername); // create a member when TJS_MEMBERENSURE is specified
    else
        data = Find((const tjs_char *)(*membername), membername->GetHint());
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSCustomObject::EnumMembers(
    tjs_uint32 flag, tTJSVariantClosure *callback, iTJSDispatch2 *objthis) {
    if (!GetValidity())
        return TJS_E_INVALIDOBJECT;
...
tTJSCustomObject::DeleteMember(tjs_uint32 flag, const tjs_char *membername,
    ...
    if (targ.Type() == tvtObject) {
        ...
        if (tvclosure.Object) {
            ...
            return tvclosure.Object->Invalidate(
                flag, nullptr, nullptr, TJS_SELECT_OBJTHIS(tvclosure, objthis));
        }
    }
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD
tTJSCustomObject::Invalidate(tjs_uint32 flag, const tjs_char *membername,
                             tjs_uint32 *hint, iTJSDispatch2 *objthis) {
    if (!GetValidity())
        return TJS_E_INVALIDOBJECT;
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSCustomObject::IsValid(tjs_uint32 flag,
                                                    const tjs_char *membername,
                                                    tjs_uint32 *hint,
                                                    iTJSDispatch2 *objthis) {
    if (membername == nullptr) {
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSCustomObject::CreateNew(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
    ...
    if (membername == nullptr) {
        // as an action of the default member, this object cannot create an
        // object because this object is not a class
        return TJS_E_INVALIDTYPE;
    }
    ...
    return TJSDefaultCreateNew(flag, GetValue(data), result, numparams, param,
                               objthis);
}
//---------------------------------------------------------------------------
/*
...
tjs_error TJSDefaultIsInstanceOf(tjs_uint32 flag, tTJSVariant &targ,
                                 const tjs_char *name, iTJSDispatch2 *objthis) {
    tTJSVariantType vt;
    vt = targ.Type();
    if (vt == tvtVoid) {
        return TJS_S_FALSE;
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSCustomObject::IsInstanceOf(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
...
tjs_error TJSDefaultOperation(tjs_uint32 flag, tTJSVariant &targ,
    ...
    if (targ.Type() == tvtObject) {
        // the member may be a property handler if the member's type is
        // "tvtObject" so here try to access the object.
        tjs_error hr;
        ...
        if (tvclosure.Object) {
            ...
            if (TJS_SUCCEEDED(hr)) {
                ...
                hr = tvclosure.Object->PropSet(0, nullptr, nullptr, &tmp, ot);
                if (TJS_FAILED(hr))
                    return hr;
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSCustomObject::Operation(
    tjs_uint32 flag, const tjs_char *membername, tjs_uint32 *hint,
    tTJSVariant *result, const tTJSVariant *param, iTJSDispatch2 *objthis) {
    if (!GetValidity())
        return TJS_E_INVALIDOBJECT;
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSCustomObject::NativeInstanceSupport(
...
//---------------------------------------------------------------------------
tjs_error TJS_INTF_METHOD tTJSCustomObject::ClassInstanceInfo(
    tjs_uint32 flag, tjs_uint num, tTJSVariant *value) {
    switch (flag) {
    case TJS_CII_ADD: {
        // add value
